...
public class PicturesUtil {
    ...
    public static File createEmptyImageFile() {
        return pictureFile(PicturesUtil.PICTURE_FILE_NAME_FORMAT.format(new Date()) + ".jpg");
    }

    public static File pictureFile(String pictureFileName) {
        return new File(PICTURES_DIR, pictureFileName);
    }
    ...
    public static void showImage(Context context, ImageView imageView, String pictureFileName) {
        ...
        Glide.with(context)
                .load(PicturesUtil.pictureFile(pictureFileName))
                .crossFade()
                //.override(320, 320)
                .into(imageView);
    }
